(function () {
  ...
  var dictionaries = {
    ca: {
      ...
      "Cambiar prueba": "Canvia la prova",
      "Selecciona una prueba": "Selecciona una prova",
      "Selecciona una prueba.": "Selecciona una prova.",
      "Selecciona una ciudad existente.": "Selecciona una ciutat existent.",
      "Característica técnica": "Característica tècnica",
      "La caracteristica tecnica es obligatoria para esta prueba.": "La característica tècnica és obligatòria per a aquesta prova.",
      "La característica técnica no es válida para la nueva prueba": "La característica tècnica no és vàlida per a la nova prova",

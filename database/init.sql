...
CREATE TABLE IF NOT EXISTS atletas (
  ...
  estado ENUM('completo', 'pendiente') NOT NULL DEFAULT 'completo',
  creado_en TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  actualizado_en TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS pistas (
  ...
  ambito ENUM('pista_cubierta', 'aire_libre', 'ruta') NOT NULL DEFAULT 'aire_libre',
  nombre VARCHAR(160) NOT NULL,
  localidad VARCHAR(120) NOT NULL,
  creado_en TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  actualizado_en TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY uq_pistas_ambito_ciudad_nombre (ambito, ciudad_id, nombre),
  KEY idx_pistas_ciudad_ambito (ciudad_id, ambito)
) ENGINE=InnoDB;

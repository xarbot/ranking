(function () {
  ...
  var dictionaries = {
    ca: {
      ...
      "Prepara las filas con los desplegables y descarga el CSV para importarlo.": "Prepara les files amb els desplegables i descarrega el CSV per importar-lo.",
      "Preparar plantilla de resultados": "Prepara la plantilla de resultats",
      "Plantilla de resultados": "Plantilla de resultats",
      "Añadir fila": "Afegeix una fila",
      "Descargar CSV preparado": "Descarrega el CSV preparat",
      "Fila": "Fila",
      "Solo si corresponde": "Només si correspon",
      "selecciona una prueba.": "selecciona una prova.",
      "ciudad no existe.": "la ciutat no existeix.",
      "CSV preparado para importar.": "CSV preparat per importar.",

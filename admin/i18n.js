(function () {
  ...
  var dictionaries = {
    ca: {
      ...
      "Crea la primera prueba para registrar marcas.": "Crea la primera prova per registrar marques.",
      ...
      "Decatlon": "Decatló",
      "Heptatlon": "Heptatló",
      "Criterio de ranking": "Criteri de rànquing",
      "Gana la marca mas baja (carreras / tiempos)": "Guanya la marca més baixa (curses / temps)",
      "Gana la marca mas alta (saltos / lanzamientos)": "Guanya la marca més alta (salts / llançaments)",

(function () {
  ...
  var dictionaries = {
    ca: {
      ...
      "Antes de guardar, la app muestra una previsualización editable con avisos de duplicados, atletas no encontrados, ciudad y pista recomendada.": "Abans de desar, l'app mostra una previsualització editable amb avisos de duplicats, atletes no trobats, ciutat i pista recomanada.",
      "Atletas no encontrados": "Atletes no trobats",
      "Previsualización de marcas": "Previsualització de marques",
      "Subir marcas revisadas": "Puja marques revisades",
      "Revisa y edita las marcas antes de subirlas.": "Revisa i edita les marques abans de pujar-les.",
      ...
      "Indica el atleta al que corresponden las marcas.": "Indica l’atleta al qual corresponen les marques.",
      ...
      "Nombre de la pista de atletismo": "Nom de la pista d'atletisme",
      "Nombre de la pista de atletismo (opcional)": "Nom de la pista d'atletisme (opcional)",
      "Marca técnica": "Marca tècnica",
      ...
      "Provincia": "Província",
      "Buscar ciudad": "Cerca ciutat",
      "Busca una ciudad para editarla. Si no existe, completa nombre y provincia para darla de alta.": "Cerca una ciutat per editar-la. Si no existeix, completa nom i província per donar-la d'alta.",
      "Ciudad creada.": "Ciutat creada.",
      "Ciudad actualizada.": "Ciutat actualitzada.",
      "Fusionar ciudad origen": "Fusiona ciutat origen",
      "Con ciudad destino": "Amb ciutat destí",
      "Fusionar": "Fusiona",
      "Selecciona ciudad origen y destino del listado.": "Selecciona ciutat origen i destí del llistat.",
      "La ciudad origen y destino deben ser diferentes.": "La ciutat origen i destí han de ser diferents.",
      "No se puede eliminar una ciudad con marcas asociadas. Fusiona la ciudad primero.": "No es pot eliminar una ciutat amb marques associades. Fusiona la ciutat primer.",
      "marcas movidas y ciudad fusionada.": "marques mogudes i ciutat fusionada.",
      ...
      "Contrasena actual": "Contrasenya actual",
      "Nueva contrasena": "Nova contrasenya",
      "Cambiar contrasena": "Canvia contrasenya",
      "Contrasena actualizada.": "Contrasenya actualitzada.",
      ...
      "Gestor de marcas": "Gestor de marques",
      ...
      "La contrasena actual no es correcta.": "La contrasenya actual no és correcta.",

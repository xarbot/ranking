(function () {
  ...
  var dictionaries = {
    ca: {
      ...
      "Descarga la plantilla Excel con desplegables, rellénala y guárdala como CSV para importarla.": "Descarrega la plantilla Excel amb desplegables, omple-la i desa-la com a CSV per importar-la.",
